...
You must read and affirmatively accept these Terms before using NivCraft. Your acceptance is recorded with the Terms version and time. If you do not agree, do not use the service. You must accept again after deleting and recreating your account. If we make a material change, we may require acceptance of a newer version.

The [Privacy Policy](privacy-policy.md) explains how NivCraft handles information and is incorporated into these Terms.

## 2. Eligibility

You must be at least 18 years old and legally capable of entering this agreement. You may use NivCraft only where lawful. If you use it for an organization, you confirm that you have authority to bind that organization.

## 3. Paper trading and no financial advice

NivCraft is an educational and simulated paper-trading service. It does not route or execute real-money orders and does not hold customer funds or securities. NivCraft is not a broker, stock exchange, investment adviser, research analyst, portfolio manager, or fiduciary.

Quotes, signals, scans, option-chain information, calculations, backtest results, rankings, behavior insights, community content, and other outputs are provided for learning and informational purposes. They are not investment advice, a research report, an offer, or a recommendation to buy, sell, or hold anything. Simulated results do not represent actual execution and do not guarantee future results. Real trading can result in substantial or total loss. Obtain qualified independent advice and perform your own research before making a real-money decision.
...
You must provide accurate information, keep your device and connected accounts secure, and promptly report suspected unauthorized access. You are responsible for activity performed through your account except to the extent caused by our breach of applicable law.

One person may not create duplicate identities to obtain repeated referrals, trials, or entitlements. You must not share authentication or broker tokens, bypass access controls, impersonate another person, or use another person's broker connection.

## 6. Broker connections

Connecting a broker authorizes NivCraft to use the resulting session for the market-data features you request. Broker services are independent, apply their own terms, and may revoke or expire access. You remain responsible for your broker account. NivCraft does not ask for or store your broker password and does not use the connection to place real orders.
...
Some features may offer an optional **rewarded ad**: if you choose to watch it in full, NivCraft grants a small extra in-app allowance for the current period, such as one or more additional paper-wallet resets. A rewarded ad never grants money, additional simulated capital, or anything of cash value. The allowance is a simulated in-app benefit only, is not transferable, and may be limited, changed, or withdrawn. Availability depends on ad fill, your tier, and configured limits.
